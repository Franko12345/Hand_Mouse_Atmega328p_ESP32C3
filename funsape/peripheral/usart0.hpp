...
bool_t Usart0::getReceptionStatus(ReceptionError *errorCode_p)
{
    ...
    debugMark(PSTR("Usart0::getReceptionStatus(ReceptionError *)"), Debug::CodeIndex::USART0_MODULE);
    ...
    if(!isPointerValid(errorCode_p)) {
        ...
        debugMessage(Error::ARGUMENT_POINTER_NULL, Debug::CodeIndex::USART0_MODULE)
        return false;
    }
    ...
    *errorCode_p = (ReceptionError)aux8;
    ...
    debugMessage(Error::NONE, Debug::CodeIndex::USART0_MODULE);
    return true;
}
*/
