...
bool_t Usart0::setDataSize(const DataSize dataSize_p)
{
    ...
    default:
        // Returns error
        this->_lastError = Error::DATA_SIZE_NOT_SUPPORTED;
        return false;
    }
...
bool_t Usart0::setStopBits(const StopBits stopBits_p)
{
    ...
    default:
        // Returns error
        this->_lastError = Error::STOP_BIT_CONFIG_NOT_SUPPORTED;
        return false;
    }
...
bool_t Usart0::setParityMode(const ParityMode parityMode_p)
{
    ...
    default:
        // Returns error
        this->_lastError = Error::PARITY_MODE_NOT_SUPPORTED;
        return false;
    }
...
bool_t Usart0::setBaudRate(const BaudRate baudRate_p)
{
    ...
    default:
        // Returns error
        this->_lastError = Error::BAUD_RATE_NOT_SUPPORTED;
        return false;
    }
...
bool_t Usart0::setFrameFormat(const FrameFormat frameFormat_p)
{
    ...
    default:
        // Returns error
        this->_lastError = Error::FRAME_FORMAT_NOT_SUPPORTED;
        return false;
    }
